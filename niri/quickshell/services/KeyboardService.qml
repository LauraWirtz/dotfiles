...
Singleton {
	...
	property list<var> layout: [
		...
		{label: "⌫", key: "KEY_BACKSPACE", x:13, y:0, width:2, height:1},

		{label: "⇥", key: "KEY_TAB", x:0, y:1, width:1.5, height:1},
		...
		{label: "esc", key: "KEY_ESC", x:0, y:2, width:1.75, height:1},
		...
		{label: "alt", key: "KEY_LEFTALT", x:2.5, y:4, width:1.25, height:1},
		{label: "", key: "KEY_SPACE", x:3.75, y:4, width:6, height:1},
		{label: "←", key: "KEY_LEFT", x:9.75, y:4, width:1, height:1},
		{label: "↓", key: "KEY_DOWN", x:10.75, y:4, width:1, height:1},
		{label: "↑", key: "KEY_UP", x:11.75, y:4, width:1, height:1},
		{label: "→", key: "KEY_RIGHT", x:12.75, y:4, width:1, height:1},
		{label: "ctrl", key: "KEY_RIGHTCTRL", x:13.75, y:4, width:1.25, height:1},
	]
